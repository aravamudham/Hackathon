...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    ViewController * circleMenuViewController;
    circleMenuViewController = [ViewController alloc];
    ...
    [[UINavigationBar appearance] setTintColor:[UIColor colorWithRed:0.0/0.0 green:128.0/256.0 blue:203.0/256.0 alpha:1.0]];
